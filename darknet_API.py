...
if __name__ == '__main__':
    ...
    detect = Detect(metaPath=r'./cfg/fall_down.data',
                    configPath=r'./cfg/yolov4-fall_down.cfg',
    ...
    ''' 读取视频，保存视频 '''
    cap = cv2.VideoCapture(r'/home/Datasets/fall_down1.avi')
    ...
    video_writer = cv2.VideoWriter(r'/home/Datasets/fall_down1.mp4', fourcc=fourcc, fps=fps, frameSize=(width,height))
